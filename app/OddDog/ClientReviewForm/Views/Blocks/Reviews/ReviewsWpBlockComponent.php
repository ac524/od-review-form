...
namespace OdReviewForm\OddDog\ClientReviewForm\Views\Blocks\Reviews;
 ...
 */
class ReviewsWpBlockComponent extends Component {

	protected $id = "OdReviewsWpBlock";
	...
	{
		if( wp_script_is("odrf-reviews-editor-script") ) {

			$blockConfig = [
				"locations" => LocationsData::instance()->all()
			];

			wp_add_inline_script("odrf-reviews-editor-script", "window.odrfReviewsBlockConfig = ". json_encode($blockConfig)) .";";
